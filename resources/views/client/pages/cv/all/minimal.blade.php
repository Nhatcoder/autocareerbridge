...
<script>
    ...
    // experience
    document
        .getElementById("add-work-experience-button")
        .addEventListener("click", function() {
                ...
                input.addEventListener("input", function() {
                    ...
                    if (target) {
                        if (this.type === "month") {
                            ...
                            const monthYear =
                                year && month ? `${month}/${year}` : "Tháng/Năm";
            ...
            newSection
                .querySelector(".delete-work-experience-button")
                .addEventListener("click", function() {
                    newSection.remove();
                    cvEntry.remove();
    ...
    // education
    document
        .getElementById("show-education-form-button")
        .addEventListener("click", function() {
            const newSection = document.createElement("div");
            newSection.classList.add(
                "input-section",
                ...
                input.addEventListener("input", function() {
                    ...
                    if (target) {
                        if (this.type === "month") {
                            const [year, month] = this.value.split("-");
                            const monthYear =
                                month && year ? `${month}/${year}` : "Tháng/Năm";
                            target.textContent = monthYear;
                        } else {
                            target.textContent = this.value || this.placeholder;
                        }
            ...
            newSection
                .querySelector(".delete-education-button")
                .addEventListener("click", function() {
                    newSection.remove();
                    cvEntry.remove();
    ...
    document
        .querySelectorAll(
            "#name, #email, #birthdate, #position, #phone, #address, #introduce"
        )
        .forEach((input) => {
    ...
    // personal introduce
    document
        .getElementById("show-personal-introduce")
        .addEventListener("click", function() {
            ...
            newSection
                .querySelector(".delete-personal-introduce-button")
                .addEventListener("click", function() {
                    newSection.remove();
                    cvEntry.remove();
