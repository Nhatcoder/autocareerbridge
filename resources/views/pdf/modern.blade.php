...
<body>
    <div class="container">
        <div class="sidebar" style="float: left; width: 30%">
            ...
            <h1>{{ $cv['name'] }}</h1>
            <p style="font-size: 17px;">{{ $cv['position'] }}</p>

            <div class="section-title">Thông tin cá nhân</div>
            <p><strong><img src="{{ asset('clients/images/iconcv/phone.svg') }}" style="width: 16px;"> </strong> {{ $cv['phone'] }}</p>
            <p><strong><img src="{{ asset('clients/images/iconcv/email.svg') }}" style="width: 16px;"> </strong> {{ $cv['email'] }}</p>
            <p><strong><img src="{{ asset('clients/images/iconcv/date.svg') }}" style="width: 16px;"> </strong> {{ $cv['date_birth'] }}</p>
            <p><strong><img src="{{ asset('clients/images/iconcv/address.svg') }}" style="width: 16px;"> </strong> Hoài Đức, Hà Nội</p>
            <p><strong><img src="{{ asset('clients/images/iconcv/link.svg') }}" style="width: 16px;"> </strong> {{ $cv['url'] }}</p>

            <div class="section-title">HỌC VẤN</div>@dd($educations)
